...
public class MoneyProcessor {
    public static void main(String[] args) {
        ...
        if (length_args == 4) {
            ...
            double total = (1000 * num_of_thousand_banknotes) + (500 * num_of_fiveHundred_banknotes) + (100 * num_of_oneHundred_banknotes)  + (20 * num_of_twenty_banknotes) ;
            System.out.println("Total Money is " + total);
        }
        else{
            System.out.println("Usage: MoneyProcessor <# of 1,000 bath Notes> <# of 500 bath Notes> <# of 100 bath Notes> <# of 20 bath Notes>");
        }
    }   
}
