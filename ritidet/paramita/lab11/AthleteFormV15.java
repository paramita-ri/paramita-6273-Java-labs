    ...
    public void saveYearFile() {
        ...
        if (returnValue == JFileChooser.APPROVE_OPTION) {// Check if returnValue is equal to JFileChooser.APPROVE_OPTION
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, "Saving experiences year in file " + fileName);// Show message
                                                                                                   // dialog "Saving
                                                                                                   // experiences year
                                                                                                   // in file " +
                                                                                                   // fileName
    ...
    public void openYearFile() {
        ...
        if (returnValue == JFileChooser.APPROVE_OPTION) {// Check if returnValue is equal to JFileChooser.APPROVE_OPTION
            ...
            try {
                ...
                ArrayList<String> wordListFormFile = new ArrayList<String>();// Create ArrayList for store word from
                                                                             // file
                ...
                if (yearInNum > 1) {// Check if yearInNum is more than 1
                    displayYearTxt = nameFromFile + " has " + yearFromFile + " years of experiences";// Set
                                                                                                     // displayYearTxt
                    bioTextArea.append("\n" + displayYearTxt);// Append displayYearTxt to bioTextArea
                } else if (yearInNum <= 1) {// Check if yearInNum is less than or equal to 1
                    displayYearTxt = nameFromFile + " has " + yearFromFile + " year of experiences";// Set
                                                                                                    // displayYearTxt
                    bioTextArea.append("\n" + displayYearTxt);// Append displayYearTxt to bioTextArea
                }
